namespace CSharpChallenges.Core.Constants;

public readonly struct CodeVariableStruct {
...
public readonly struct CodeArray{
    ...
    public static readonly string[] WordAry01 = ["baseball", "a,all,ball,bas,base,cat,code,d,e,quit,z"];
    public static readonly string[] WordAry02 = ["abcgefd", "a,ab,abcg,b,c,dog,e,efd,zzz"];
    public static readonly string[] WordAry03 = ["abcgefd", "a,ab,abcg,b,c,dog,e,zzz"];
